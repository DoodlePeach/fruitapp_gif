...
class CalenderWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Calender controller for listening to click events and setting
    // holidays etc
    // We do not need this, but since this is a required argument to
    // our calender widget, we have to declare this anyway.
